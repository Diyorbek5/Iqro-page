  ...
  return (
    <div id="contact">
      <Container className="m-20">
        <div className="bg-gray-800 grid gap-10 sm:grid-cols-1 md:grid-cols-7 lg:grid-cols-7 xl:grid-cols-7 dark:bg-trueGray-800 rounded-3xl border border-gray-500">
          <div className="sm:col-span-1 md:col-span-4 lg:col-span-4 xl:col-span-4">
            <div className="rounded-3xl flex flex-col justify-start w-full h-full px-16 py-12">
              <h2 className="z-10 text-2xl font-bold leading-snug tracking-tight text-white lg:text-4xl lg:leading-tight xl:text-4xl">
                Сколько стоят услуги
              </h2>
              <p className="z-10 py-5 text-xl text-white leading-normal lg:text-xl xl:text-xl">
                ...
                {show &&
                  <div className="z-10">
                    <div className="flex flex-col justify-between items-center flex-wrap mb-12 z-10">
                      <h2 className="z-10 text-xl font-bold leading-snug tracking-tight text-white lg:text-3xl lg:leading-tight xl:text-3xl">
                        Получить
                        бесплатную
                        консультацию
                      </h2>
                    ...
                    <div className="z-10 order-last flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                      <a
                        ...
                        rel="noopener"
                        className="transition ease-in-out delay-80 hover:bg-teal-900 hover:-translate-y hover:scale-90 duration-200 hover:text-teal-500 px-8 py-4 text-lg w-full font-medium text-center text-black bg-indigo-600">
                        Обсудить проект
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="z-10">
                    ...
                    <div className="z-10 flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                      <a
                        ...
                        rel="noopener"
                        className="transition ease-in-out delay-80 hover:bg-teal-900 hover:-translate-y hover:scale-90 duration-200 hover:text-teal-500  text-teal-500 px-8 py-4 text-lg w-full font-medium text-center bg-indigo-600">
                        Отправить
                      </a>
                    </div>
                  </div>}
