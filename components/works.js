...
const Testimonials = () => {
  return (
    <Container>
      <div className="bg-gray-800 grid gap-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 dark:bg-trueGray-800 rounded-3xl border border-gray-500">
        <div className="lg:col-span-1 xl:col-auto">
          <div className="rounded-3xl flex flex-col-2 justify-start items-center w-full h-full px-10 py-7 dark:bg-trueGray-800">
            <Img className="z-10 object-cover w-20 h-20" src={img1} alt="image" />
            <p className="z-10 text-2xl leading-normal pl-8 text-white">
