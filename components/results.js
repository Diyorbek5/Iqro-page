        ...
        <Container className="grid place-items-center">
            <div className="w-5/6 grid content-center gap-10 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                <div className="lg:col-span-1 xl:col-auto">
                    <div style={{ borderRadius: '2em'}} className="flex flex-col justify-between w-full h-full bg-gray-100 px-12 rounded-1xl py-12 dark:bg-trueGray-800 border border-gray-500">
                        <Img style={{position:'relative', top:'-50px',left:'-50px'}} className="z-10 w-51 h-51" alt="done image" src={done}/>
                        <p style={{marginTop:'-50px'}} className="z-10 text-xl leading-normal">
                            Автоматизация <br />
                            бизнес-процессов
                        </p>
                    </div>
